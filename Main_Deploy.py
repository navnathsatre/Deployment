...
def collecting_data (Date1,Date2):
    ...
    date_since=Date1
    data_until=Date2
    tweets = tweepy.Cursor(api.search,q=search_words,lang="en",tweet_mode='extended',since=date_since,until=data_until,result_type="recent").items(100)
